package com.achdev.onlinebookstoreapp.util;
...
public class ApiResponseConstants {
    ...
    public static final String CATEGORY_CREATE_DESCRIPTION = "Create a new category";
    public static final String CATEGORY_UPDATE_DESCRIPTION = "Update a category by Id";
    public static final String CATEGORY_DELETE_DESCRIPTION = "Delete a category by Id";
    public static final String BOOK_CREATE_DESCRIPTION = "Create a new book";
    public static final String BOOK_UPDATE_DESCRIPTION = "Update a book by Id";
